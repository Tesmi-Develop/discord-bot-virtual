...
Command.add('идеи', 'Данная команда изменит текущий канал под канал для идей. (Удалит команду сразу, а свое сообщение после 10 секунд)', (client, message) => {
